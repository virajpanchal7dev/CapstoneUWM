	      ...
	      <c:if test = "${ud == 'Admin'}">
	        <div class="box">
	          <div class="right-side">
	            <div class="box-topic">Pending Housing Request</div>
	        ...
	        <div class="box">
	          <div class="right-side">
	            <div class="box-topic">Transportation Request</div>
	            <div class="number">${tcnt}</div>
	            <!-- <div class="indicator">
	              <i class='bx bx-up-arrow-alt'></i>
	              <span class="text">Up from yesterday</span>
	            </div> -->
	        ...
	        <!-- <div class="box">
	          <div class="right-side">
	            <div class="box-topic">Others</div>
