		      ...
		      <div class="col-lg-10">
		        <div class="card shadow-sm">
		          ...
		          <div class="card-body">
				    ...
				    <form method="post" action="processtransportation">
				    <input type="hidden" id="id" name="id" value="${user.id}" />
					    <table class="table table-bordered">
					    	<tr>
				                <th width="30%">Flight Date</th>
				                <td width="2%">:</td>
				                <td><input type="date" id="flightdate" name="flightdate" required="required"></td>
			              	</tr>
			              	<tr>
				                <th width="30%">Arrival Date</th>
				                <td width="2%">:</td>
				                <td><input type="date" id="arrivaldate" name="arrivaldate" required="required"></td>
			              	</tr>
			              	<tr>
				                <th width="30%">From</th>
				                <td width="2%">:</td>
				                <td>Chicago O'Hare Airport, IL</td>
			              	</tr>
			              	<tr>
				                <th width="30%">To</th>
				                <td width="2%">:</td>
						...
						<input type="submit" value="Request for Transportation to MKE">
				    </form>
